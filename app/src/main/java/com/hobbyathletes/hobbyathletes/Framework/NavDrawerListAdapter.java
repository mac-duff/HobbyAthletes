...
public class NavDrawerListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView txtCount = (TextView) convertView.findViewById(R.id.drawer_list_item_counter);

        if(navDrawerItems.get(position).getImagePic() != null) {
            imgIcon.setImageBitmap(Tool.cutCircle(navDrawerItems.get(position).getImagePic()));
        }
